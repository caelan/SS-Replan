(define (domain nvidia-tamp)
  ...
  (:action pick
    ...
    :effect (and (AtGrasp ?o1 ?g) (CanMoveBase)
  ...
  (:action place
    ...
    :effect (and (AtRelPose ?o1 ?rp ?o2) (AtWorldPose ?o1 ?p1) (HandEmpty) (CanMoveBase)
                 (not (AtGrasp ?o1 ?g))
  ...
  (:action pull
    ...
    :effect (and (AtAngle ?j ?a2) (CanMoveBase)
                 (not (AtAngle ?j ?a1))
                 (AtWorldPose ?o ?p2)
